...
async function getGameInfo(slug) {
  try {
    ...
    const description = dom.window.document.querySelector('div.description');
...
async function create(name, entityName) {
  ...
  console.log(`Name in create function: ${name} and entityName: ${entityName}`)
  if (!item) {
...
module.exports = {
  populate: async (params) => {
    try {
      ...
      console.log(`Calling URL: ${gogApiUrl}`)
